...
public class CalculadoraEstadisticas
{
	...
	/**
	 * Informa el pais al cual pertenece un atleta.
	 * @param mombre: Nombre de el atleta que desea consultar
	 * @return Pais al que pertenece el atleta
	 */
	public String paisDeAtleta(String nombre) {
		String pais = null;
		for (Atleta atleta : atletas){
			if (atleta.darNombre().contains(nombre)){
