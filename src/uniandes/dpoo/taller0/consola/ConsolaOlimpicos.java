...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("14. Slir de la aplicación\n");
	}
	
	/**
	 * Solicita al usuario el nombre de un atleta y muestra el pais al que representa
	 */
	private void ejecutarPaisDeAtleta() {
		...
		if(pais != null) {
			System.out.println(nombre+" pertenece a: "+pais);
		}else {
